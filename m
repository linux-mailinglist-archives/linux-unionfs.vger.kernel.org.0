Return-Path: <linux-unionfs+bounces-2049-lists+linux-unionfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-unionfs@lfdr.de
Delivered-To: lists+linux-unionfs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 99634B59898
	for <lists+linux-unionfs@lfdr.de>; Tue, 16 Sep 2025 16:03:25 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 931C61C025CD
	for <lists+linux-unionfs@lfdr.de>; Tue, 16 Sep 2025 14:02:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7369034167E;
	Tue, 16 Sep 2025 13:59:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="Dec1Bfed"
X-Original-To: linux-unionfs@vger.kernel.org
Received: from mail-wm1-f45.google.com (mail-wm1-f45.google.com [209.85.128.45])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 59DAF3375B3
	for <linux-unionfs@vger.kernel.org>; Tue, 16 Sep 2025 13:59:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.45
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1758031187; cv=none; b=gejhGDSoI+c8CXMAFzCt46wrlE8n0/PILMj6pw3+r5WnYhDeUESK02R4mE2QDUYiFFGspD7fwI1dn33GzEAGa0p4YtICLtCAKgLmVP2d9SrbesUZ15ggBuG2PXOiHflwJwpZSTlyNjj+r9wQawj5c3cw9N36DcBPbLdpddteb0M=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1758031187; c=relaxed/simple;
	bh=qt/YFUMkKt8IA45+qE2taOxYKW10Ub+uwNHV94/ZlR4=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=LBkNmQzj1EUiZnlfjdK8rrQNpABYtTki6i8gs5BHfKqHdLqw3o8R2A6659XusZgcFqAM6LquYn7BDD5i+ICr7hjEzkCMSyz9sJppegV4mp9JMdmEQggJ8BIvHC1ZhWigUNW2l54sD+qqi0Ues4lgCDDBjQAqs1H8u5uTkAaW+Xk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=Dec1Bfed; arc=none smtp.client-ip=209.85.128.45
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-wm1-f45.google.com with SMTP id 5b1f17b1804b1-45df7dc1b98so37975335e9.1
        for <linux-unionfs@vger.kernel.org>; Tue, 16 Sep 2025 06:59:40 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1758031178; x=1758635978; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=LdH6hYb9zcGIjyPlmmt41hP/wfdaqw8hE+DlLYlc4Lc=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1758031178; x=1758635978;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=LdH6hYb9zcGIjyPlmmt41hP/wfdaqw8hE+DlLYlc4Lc=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVPV5qpxB8Tk6Gk7m2UwwCxSUJuZgAl5pYoxnrjmOuofvOtowmb0r8Amdf9pgQ+h0QnZob6cWqQjgrlmSFc@vger.kernel.org
X-Gm-Message-State: AOJu0YwNWTr9Fo6c0KeqKBnq5Eyv3NTKBfG54zSzKcwrn/B/mHQs/eTE
	5tL1vVzTeYsqjHE6dhRm/QZS89GywmWp8GOvUAdCcdmzY8LSqGiGj84Q
X-Gm-Gg: 
X-Google-Smtp-Source: AGHT+IFjSe0p9uGvCdqarbYDqX67a8jlLsyS6XVRIE5LQEMQR8Zjxl6EiH+L2syMsSzuRb+I8kSsjQ==
X-Received: by 2002:a05:6000:144c:b0:3eb:f90a:f6cd with SMTP id ffacd0b85a97d-3ebf90af732mr4593567f8f.60.1758031178093;
        Tue, 16 Sep 2025 06:59:38 -0700 (PDT)
Received: from f.. (cst-prg-88-146.cust.vodafone.cz. [46.135.88.146])
        by smtp.gmail.com with ESMTPSA id ffacd0b85a97d-3e7cde81491sm16557991f8f.42.2025.09.16.06.59.36
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 16 Sep 2025 06:59:37 -0700 (PDT)
...
Subject: [PATCH v4 03/12] fs: mechanically convert most filesystems to use ->i_state accessors
Date: Tue, 16 Sep 2025 15:58:51 +0200
Message-ID: <20250916135900.2170346-4-mjguzik@gmail.com>
...
inode->i_state = I_A | I_B      => inode_state_set_raw(inode, I_A | I_B)
 ...
 fs/ufs/inode.c               |  2 +-
 fs/zonefs/super.c            |  4 ++--
 54 files changed, 81 insertions(+), 82 deletions(-)

diff --git a/fs/9p/vfs_inode.c b/fs/9p/vfs_inode.c
index 399d455d50d6..a257833d4d15 100644
--- a/fs/9p/vfs_inode.c
+++ b/fs/9p/vfs_inode.c
...
index 5b5fda617b80..f99ecf002d34 100644
...
index e9538e91f848..92becefc3bbf 100644
--- a/fs/afs/inode.c
+++ b/fs/afs/inode.c
...
index 687af0eea0c2..f03b02ff3e76 100644
--- a/fs/bcachefs/fs.c
+++ b/fs/bcachefs/fs.c
...
+		inode_state_add_raw(&inode->v, I_NEW);
 		/*
...
index b002e9b734f9..b11e92a7406d 100644
--- a/fs/cramfs/inode.c
+++ b/fs/cramfs/inode.c
...
index 72fbe1316ab8..cd75f5d85258 100644
...
index 9a2f59721522..d06286191c90 100644
--- a/fs/erofs/inode.c
+++ b/fs/erofs/inode.c
...
index ecb869e895ab..1bf3ddebf860 100644
--- a/fs/fuse/inode.c
+++ b/fs/fuse/inode.c
...
index 72d95185a39f..49c456f966cc 100644
--- a/fs/gfs2/file.c
+++ b/fs/gfs2/file.c
...
index fe0faad4892f..984bae7c1460 100644
--- a/fs/gfs2/glops.c
+++ b/fs/gfs2/glops.c
...
index 8760e7e20c9d..7e0ceccf2691 100644
--- a/fs/gfs2/inode.c
+++ b/fs/gfs2/inode.c
...
index e86e1e235658..4076904ac1cd 100644
--- a/fs/hfs/btree.c
+++ b/fs/hfs/btree.c
...
index bf4cb7e78396..5fda94e20a93 100644
--- a/fs/hfs/inode.c
+++ b/fs/hfs/inode.c
...
index 86351bdc8985..b63406d4be2b 100644
...
index 01e516175bcd..1ff5b9d1b1a5 100644
...
index fcedeb514e14..15fb2ee7f799 100644
--- a/fs/jfs/inode.c
+++ b/fs/jfs/inode.c
...
index be17e3c43582..a3dd2d6b0805 100644
...
index 3c293a5a21b1..7abd305facdb 100644
--- a/fs/kernfs/inode.c
+++ b/fs/kernfs/inode.c
...
index df9d11479caf..e0d857489044 100644
--- a/fs/minix/inode.c
+++ b/fs/minix/inode.c
...
index b52805951856..c54981ed88fc 100644
--- a/fs/nfs/inode.c
+++ b/fs/nfs/inode.c
...
index 98ab55ba3ced..e03acfd14787 100644
--- a/fs/nfsd/vfs.c
+++ b/fs/nfsd/vfs.c
...
index 37cbbee7fa58..c72b1b443bfa 100644
--- a/fs/ntfs3/inode.c
+++ b/fs/ntfs3/inode.c
...
index 14bf440ea4df..c0a1bb74e4a7 100644
--- a/fs/ocfs2/inode.c
+++ b/fs/ocfs2/inode.c
...
index 3bd85ab2deb1..3e6d0ddc707c 100644
...
index 211d5b8b42f4..3918c9820a35 100644
...
index d5918eba27e3..8fbcc361f9a2 100644
...
index e75a6cec67be..5f5de8de0268 100644
--- a/fs/ubifs/file.c
+++ b/fs/ubifs/file.c
...
index a0269ba96e3d..4a7b16f5cb7d 100644
--- a/fs/ubifs/super.c
+++ b/fs/ubifs/super.c
...
index f24aa98e6869..de232d400f6a 100644
--- a/fs/udf/inode.c
+++ b/fs/udf/inode.c
...
index 4dc7f967c861..b3d46ce657d0 100644
--- a/fs/zonefs/super.c
+++ b/fs/zonefs/super.c
