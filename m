...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5B8624F7DF0
	for <lists+linux-unionfs@lfdr.de>; Thu,  7 Apr 2022 13:22:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S244740AbiDGLYn (ORCPT <rfc822;lists+linux-unionfs@lfdr.de>);
        Thu, 7 Apr 2022 07:24:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50450 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S244773AbiDGLYl (ORCPT
        <rfc822;linux-unionfs@vger.kernel.org>);
        Thu, 7 Apr 2022 07:24:41 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3C547F1E96
        for <linux-unionfs@vger.kernel.org>; Thu,  7 Apr 2022 04:22:38 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id B3D9B61E51
        for <linux-unionfs@vger.kernel.org>; Thu,  7 Apr 2022 11:22:37 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 3F366C385A0;
        Thu,  7 Apr 2022 11:22:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1649330557;
        bh=sVtEF62gBvarwINxs8uNgwJGQ+V2Z7wuuYvg8x5OI5M=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v5 04/19] ovl: pass ofs to creation operations
Date:   Thu,  7 Apr 2022 13:21:41 +0200
Message-Id: <20220407112157.1775081-5-brauner@kernel.org>
X-Mailer: git-send-email 2.32.0
In-Reply-To: <20220407112157.1775081-1-brauner@kernel.org>
References: <20220407112157.1775081-1-brauner@kernel.org>
MIME-Version: 1.0
X-Developer-Signature: v=1; a=openpgp-sha256; l=28604; h=from:subject; bh=sVtEF62gBvarwINxs8uNgwJGQ+V2Z7wuuYvg8x5OI5M=; b=owGbwMvMwCU28Zj0gdSKO4sYT6slMST5nfTsaAjYbcDO0hPMXfXAzTXdf3rNxTPlCZamstffhaSd 4r3eUcrCIMbFICumyOLQbhIut5ynYrNRpgbMHFYmkCEMXJwCMJH8VkaGeX//xluf9Q2svW16c6Gf9R yuDXcOb10Zf6VrYUnz7BcHKhn+KQqLl3wxCr1j8UF7cdzDGTUbJvQYqYra1GQfu1Sv/SuRBQA=
...
index 73cc827b5bc2..6bffef002ea5 100644
...
+	ovl_cleanup(ofs, wdir, opaquedir);
 ...
 out_unlock:
 	unlock_rename(workdir, upperdir);
@@ -496,7 +499,7 @@ static int ovl_create_over_whiteout(struct dentry *dentry, struct inode *inode,
...
+	newdentry = ovl_create_temp(ofs, workdir, cattr);
 	...
 	if (IS_ERR(newdentry))
 		goto out_dput;
@@ -534,20 +537,20 @@ static int ovl_create_over_whiteout(struct dentry *dentry, struct inode *inode,
 		if (err)
 			goto out_cleanup;
...
+		ovl_cleanup(ofs, udir, newdentry);
 ...
 out_dput:
@@ -562,7 +565,7 @@ static int ovl_create_over_whiteout(struct dentry *dentry, struct inode *inode,
 	return err;
...
@@ -802,6 +805,7 @@ static int ovl_remove_and_whiteout(struct dentry *dentry,
...
+	struct ovl_fs *ofs = OVL_FS(dentry->d_sb);
 	...
 	struct dentry *upper;
@@ -828,9 +832,9 @@ static int ovl_remove_upper(struct dentry *dentry, bool is_dir,
 		goto out_dput_upper;
...
+		err = ovl_do_unlink(ofs, dir, upper);
 	...
 	/*
@@ -1097,6 +1101,7 @@ static int ovl_rename(struct user_namespace *mnt_userns, struct inode *olddir,
...
+	struct ovl_fs *ofs = OVL_FS(old->d_sb);
 	...
 	err = -EINVAL;
@@ -1253,13 +1258,13 @@ static int ovl_rename(struct user_namespace *mnt_userns, struct inode *olddir,
 	if (err)
 		goto out_dput;
