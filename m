Return-Path: <linux-unionfs+bounces-2088-lists+linux-unionfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-unionfs@lfdr.de
Delivered-To: lists+linux-unionfs@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 36ECFB95823
	for <lists+linux-unionfs@lfdr.de>; Tue, 23 Sep 2025 12:49:23 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 7C2D47A77FA
	for <lists+linux-unionfs@lfdr.de>; Tue, 23 Sep 2025 10:47:37 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 63BD6322A36;
	Tue, 23 Sep 2025 10:47:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="Z5taIDPz"
X-Original-To: linux-unionfs@vger.kernel.org
Received: from mail-wr1-f50.google.com (mail-wr1-f50.google.com [209.85.221.50])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5708032253F
	for <linux-unionfs@vger.kernel.org>; Tue, 23 Sep 2025 10:47:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.221.50
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1758624459; cv=none; b=att20nVajQhB7uXGDk2R6asapc4pcESv/7mTnwIn66k4pTf4Zhd7AzKqAA7eM8QJccpG0YJiXTeRZKZU5Xqor3GJfN7FvZPNylBQ9cfJIEeMPc1VnE7yP9602PyGIlQR2sUWSMCNup7jUv3cwUiAt65qVnihE9IgmeN8s++kOc8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1758624459; c=relaxed/simple;
	bh=yT+xGaOz7OmFv69/+o8MGacPJrdyzVQid3AoAbrKAtk=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=efk/x9cidF9c01A2TODhe/W0VvOu2alGqZVUuW1/3bd4l3K9KVhGb4UAAEJZKSeVSA4aKrj8vEUfFUNWgmN46xq1jBA9+8znyvKkSSPsu4V1axOxNiR1Vv9wDgLobUnVKESAe9WhDlN7Ppz4jZ7dI9dF7vm2hWgd/nt2IsXiNdA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=Z5taIDPz; arc=none smtp.client-ip=209.85.221.50
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-wr1-f50.google.com with SMTP id ffacd0b85a97d-3ee13baf2e1so3952235f8f.3
        for <linux-unionfs@vger.kernel.org>; Tue, 23 Sep 2025 03:47:31 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1758624450; x=1759229250; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=UODvpC91Z/Ip8R1xEqmmP+QxXcQ8fbkYPXQfAY9Q82M=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=UODvpC91Z/Ip8R1xEqmmP+QxXcQ8fbkYPXQfAY9Q82M=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWZ/RN/9iMjR8s70Y5wxVELljI5wU3Z/v4TFwEwa0NbzHMYzQiEG8DQLmHCu3TO/sMsxMOuX/oBlm53qilF@vger.kernel.org
X-Gm-Message-State: AOJu0Yw6vGiHD0bt2g8Aypmh5r7Ed5HYI4EVHgrgZfGaBOXr6li3b7Gt
	/USajCd33svqd/tFpCKvUPbry+sPUhp31F9NrkLy2xgBsB0aHevT8SBR
X-Gm-Gg: 
X-Google-Smtp-Source: AGHT+IF7C1CLEZb1SdYQ/1hAqCr/tKifBwsXuhfHSZynoCCDv9qNZUMIFZ+C1a4XPIGtdQsHAA6AeQ==
X-Received: by 2002:a05:6000:24c1:b0:3ec:6259:5079 with SMTP id ffacd0b85a97d-405c3e27214mr1789950f8f.11.1758624448895;
        Tue, 23 Sep 2025 03:47:28 -0700 (PDT)
Received: from f.. (cst-prg-21-74.cust.vodafone.cz. [46.135.21.74])
        by smtp.gmail.com with ESMTPSA id 5b1f17b1804b1-46e23adce1bsm9710525e9.24.2025.09.23.03.47.24
...
Subject: [PATCH v6 2/4] Convert the kernel to use ->i_state accessors
Date: Tue, 23 Sep 2025 12:47:08 +0200
Message-ID: <20250923104710.2973493-3-mjguzik@gmail.com>
...
index 480cb3a1d639..6e049426c80f 100644
--- a/fs/ceph/inode.c
+++ b/fs/ceph/inode.c
...
index 60046ae23d51..2cb340c52191 100644
--- a/fs/dcache.c
+++ b/fs/dcache.c
...
index ed54c4d0f2f9..963ee303dd70 100644
--- a/fs/ext4/inode.c
+++ b/fs/ext4/inode.c
...
index 6088a67b2aae..f521ef30d9a4 100644
--- a/fs/fs-writeback.c
+++ b/fs/fs-writeback.c
...
index 1a9d4fa5e0cb..4b54aba2e939 100644
--- a/fs/inode.c
+++ b/fs/inode.c
...
+	inode_state_assign(inode, I_FREEING | I_CLEAR);
 }
...
+	inode_state_clear(inode, I_NEW);
 	 ...
 	 * Pairs with the barrier in prepare_to_wait_event() to make sure
 	 * ___wait_var_event() either sees the bit cleared or
@@ -1310,7 +1310,7 @@ struct inode *inode_insert5(struct inode *inode, unsigned long hashval,
...
@@ -1452,7 +1452,7 @@ struct inode *iget_locked(struct super_block *sb, unsigned long ino)
 		if (!old) {
 			inode->i_ino = ino;
 			spin_lock(&inode->i_lock);
-			inode->i_state = I_NEW;
...
@@ -1545,7 +1545,7 @@ EXPORT_SYMBOL(iunique);
...
@@ -1741,7 +1741,7 @@ struct inode *find_inode_rcu(struct super_block *sb, unsigned long hashval,
...
@@ -1780,7 +1780,7 @@ struct inode *find_inode_by_ino_rcu(struct super_block *sb,
 	hlist_for_each_entry_rcu(inode, head, i_hash) {
 		if (inode->i_ino == ino &&
 		    inode->i_sb == sb &&
-		    !(READ_ONCE(inode->i_state) & (I_FREEING | I_WILL_FREE)))
+		    !(inode_state_read(inode) & (I_FREEING | I_WILL_FREE)))
 	...
 	return NULL;
@@ -1804,7 +1804,7 @@ int insert_inode_locked(struct inode *inode)
 			if (old->i_sb != sb)
 				continue;
...
@@ -1812,13 +1812,13 @@ int insert_inode_locked(struct inode *inode)
 		}
 		if (likely(!old)) {
 			spin_lock(&inode->i_lock);
-			inode->i_state |= I_NEW | I_CREATING;
...
+		if (unlikely(inode_state_read(old) & I_CREATING)) {
 			...
 			spin_unlock(&inode_hash_lock);
 			return -EBUSY;
@@ -1843,7 +1843,7 @@ int insert_inode_locked4(struct inode *inode, unsigned long hashval,
...
@@ -1886,14 +1886,14 @@ static void iput_final(struct inode *inode)
...
+	state = inode_state_read(inode);
 	if (!drop) {
 		...
 		spin_unlock(&inode->i_lock);
@@ -1901,7 +1901,7 @@ static void iput_final(struct inode *inode)
...
@@ -1931,7 +1931,7 @@ void iput(struct inode *inode)
...
@@ -1942,14 +1942,14 @@ void iput(struct inode *inode)
...
index ce8c496a6940..94f4eac01aee 100644
--- a/fs/libfs.c
+++ b/fs/libfs.c
...
@@ -1664,7 +1664,7 @@ struct inode *alloc_anon_inode(struct super_block *s)
 	 ...
 	 */
-	inode->i_state = I_DIRTY;
+	inode_state_assign(inode, I_DIRTY);
 	/*
...
index cd43ff89fbaa..349d00bb7f43 100644
--- a/fs/namei.c
+++ b/fs/namei.c
...
index 20748bcfbf59..b07f7300b1b8 100644
--- a/fs/netfs/misc.c
+++ b/fs/netfs/misc.c
...
index fa622a6cd56d..c583df11f903 100644
...
index 14bf440ea4df..549f9c145dcc 100644
--- a/fs/ocfs2/inode.c
+++ b/fs/ocfs2/inode.c
...
-	inode->i_state &= ~I_WILL_FREE;
+	WARN_ON(inode_state_read(inode) & I_NEW);
+	inode_state_clear(inode, I_WILL_FREE);
...
index 70b8687dc45e..c58102146eb4 100644
...
index a33115e7384c..4bb6d4d409de 100644
...
index 731622d0738d..c9a0b8b8ed94 100644
--- a/fs/pipe.c
+++ b/fs/pipe.c
...
index 4cf7abe50143..778ebeaa4591 100644
...
@@ -345,7 +345,7 @@ xfs_reinit_inode(
 	...
 	inode->i_gid = gid;
-	inode->i_state = state;
+	inode_state_assign(inode, state);
...
index df8eab11dc48..85530a764c62 100644
...
+	inode_state_set(VFS_I(tmpfile), I_LINKABLE);
...
+		inode_state_clear(VFS_I(du_wip.ip), I_LINKABLE);
 	}
 
 out_commit:
diff --git a/fs/xfs/xfs_inode_item.c b/fs/xfs/xfs_inode_item.c
index 829675700fcd..5a66d83cc58d 100644
...
index 149b5460fbfd..d0a285db5981 100644
--- a/fs/xfs/xfs_iops.c
+++ b/fs/xfs/xfs_iops.c
