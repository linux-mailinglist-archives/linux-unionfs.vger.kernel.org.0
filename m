Return-Path: <linux-unionfs+bounces-638-lists+linux-unionfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-unionfs@lfdr.de
Delivered-To: lists+linux-unionfs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 89F11891139
	for <lists+linux-unionfs@lfdr.de>; Fri, 29 Mar 2024 03:07:08 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 34FA028CC55
	for <lists+linux-unionfs@lfdr.de>; Fri, 29 Mar 2024 02:07:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A369134CD5;
	Fri, 29 Mar 2024 01:55:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="tB3V0LsU"
X-Original-To: linux-unionfs@vger.kernel.org
Received: from mail-yw1-f201.google.com (mail-yw1-f201.google.com [209.85.128.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A8F2313BC2D
	for <linux-unionfs@vger.kernel.org>; Fri, 29 Mar 2024 01:55:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711677329; cv=none; b=i61viTUzGe32Vk0m1VNLVPIuCIIi7bsacvgM1viSYHqJbDwXF6BRnv7H+cz0Zp5tNgLZ+9lsiUprz3iqpU+Y+3ygOUPx4C3tl3zwYyiU0i1Uw3bibmjs4rm+z8jTl0/iuPtOBupn6ZnHGibUsvcC7UoDJQ3lvoq04n+i0oX/aOA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711677329; c=relaxed/simple;
	bh=zndw1+p8QwbF5PmXC/NXcskRa864acO/sGWDwAXX9Y4=;
	h=Date:In-Reply-To:Mime-Version:References:Message-ID:Subject:From:
	 To:Cc:Content-Type; b=PYOH/NYk3/iGnj2lzYEaFmvvRJJkzIUmHOr28PzwYTJ9bMrDk+wBx24hly0Ng/Ed2iGGOU9L8KUYrx6v60QR4RUOzs0ZGyatuOunfviegc2LOBjDNfRR8m4kVI4DyhSe7HwYrE2rVwiUl9RhZd6AkL2X0GMfBiuGLfY7cpxDKVI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--drosen.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=tB3V0LsU; arc=none smtp.client-ip=209.85.128.201
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--drosen.bounces.google.com
Received: by mail-yw1-f201.google.com with SMTP id 00721157ae682-614326753f1so8282887b3.1
        for <linux-unionfs@vger.kernel.org>; Thu, 28 Mar 2024 18:55:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1711677317; x=1712282117; darn=vger.kernel.org;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=7KP299CLRr6vuf+6zYwNRNzJ4OYt2CpZgwuzda4ze5Q=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1711677317; x=1712282117;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=7KP299CLRr6vuf+6zYwNRNzJ4OYt2CpZgwuzda4ze5Q=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCV1TaJJJRPuxIZJuCQC4SwoRSE8UIddW3ts+7DqA0/hcVcbFB7Y4iQhp9M2ay3ntoonRPgWlhi1EUfonIHrKWuZm4zyAVa2JmyIFybTOA==
X-Gm-Message-State: AOJu0YxW/z523PuMWyNlgfyFwR2NafosLmGDKUJUwXKsZEuWj+DpVrE1
	lUtMjjGabmI0OUOLlCUOWOgT5FPrHcBamdmpCU4+fV0d+xpHApQCgY/MOtwU/pKvAbitJKm3SGh
	g5A==
X-Google-Smtp-Source: AGHT+IER1vw1g4SXSdVW/PPCNk8GjY/SdMU1H1wBZ6Zv0i/G1qqE1tvi0NDy5kQVZwGjaH7jprR6wZxm8oU=
X-Received: from drosen.mtv.corp.google.com ([2620:15c:211:201:fcce:d6ab:804c:b94b])
 (user=drosen job=sendgmr) by 2002:a0d:eb47:0:b0:60a:6a5d:7db0 with SMTP id
 u68-20020a0deb47000000b0060a6a5d7db0mr269936ywe.0.1711677317658; Thu, 28 Mar
 2024 18:55:17 -0700 (PDT)
Date: Thu, 28 Mar 2024 18:53:50 -0700
...
Message-ID: <20240329015351.624249-36-drosen@google.com>
Subject: [RFC PATCH v4 35/36] fuse-bpf: Add selftests
...
---
 ...
 12 files changed, 5745 insertions(+)
...
new file mode 100644
index 000000000000..6d51fce34c32
--- /dev/null
...
+	     src_fd != -1);
+	TEST(test_skel = test_bpf__open_and_load(), test_skel != NULL);
+	TEST(test_link = bpf_map__attach_struct_ops(test_skel->maps.legacy_ops), test_link != NULL);
+	TESTEQUAL(mount_fuse(mount_dir, "legacy_ops", src_fd, &fuse_dev), 0);
+
+	FUSE_ACTION
+		int i;
+		int fd;
...
new file mode 100644
index 000000000000..1d31948264f4
--- /dev/null
...
+}
+
+BPF_STRUCT_OPS(uint32_t, user_lookup_prefilter, const struct bpf_fuse_meta_info *meta,
+				struct fuse_buffer *name)
+{
+	struct bpf_dynptr name_ptr;
+	char *name_buf;
...
+	.write_iter_prefilter = (void *)trace_write_iter_prefilter,
+	.file_fallocate_prefilter = (void *)trace_file_fallocate_prefilter,
+	.lookup_prefilter = (void *)user_lookup_prefilter,
+	.mknod_prefilter = (void *)trace_mknod_prefilter,
+	.mkdir_prefilter = (void *)trace_mkdir_prefilter,
+	.rmdir_prefilter = (void *)trace_rmdir_prefilter,
+	.rename2_prefilter = (void *)trace_rename2_prefilter,
