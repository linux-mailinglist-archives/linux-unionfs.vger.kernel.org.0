...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id CDC38120373
	for <lists+linux-unionfs@lfdr.de>; Mon, 16 Dec 2019 12:13:39 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727414AbfLPLMj (ORCPT <rfc822;lists+linux-unionfs@lfdr.de>);
        Mon, 16 Dec 2019 06:12:39 -0500
Received: from mail-pf1-f195.google.com ([209.85.210.195]:39109 "EHLO
        mail-pf1-f195.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727229AbfLPLMj (ORCPT
        <rfc822;linux-unionfs@vger.kernel.org>);
        Mon, 16 Dec 2019 06:12:39 -0500
Received: by mail-pf1-f195.google.com with SMTP id 2so5398591pfx.6
        for <linux-unionfs@vger.kernel.org>; Mon, 16 Dec 2019 03:12:38 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id;
        bh=jVcQ+9tIfDFUg+vx8SgXY8YnIBVL98MBGgf6vGgkY2c=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id;
        bh=jVcQ+9tIfDFUg+vx8SgXY8YnIBVL98MBGgf6vGgkY2c=;
        b=
X-Gm-Message-State: APjAAAVgwr1N0m/Ec3hilL64WMXoyCie+6TsqGFtsstqhTSbZgX+C3fO
        u6KX+b2rUVwDmCtzsdKHdAY=
X-Google-Smtp-Source: APXvYqz42m8qg7ukVU0dm4hIZMoWQik4/E1SuU2IkBNnKykkDgI4QamJKq7X4QAFkSXMGoQR+UlULg==
X-Received: by 2002:aa7:870c:: with SMTP id b12mr15387134pfo.82.1576494757774;
        Mon, 16 Dec 2019 03:12:37 -0800 (PST)
Received: from localhost ([43.224.245.181])
        by smtp.gmail.com with ESMTPSA id c8sm22151218pfo.163.2019.12.16.03.12.36
...
Subject: [PATCH v2] ovl: use pr_fmt auto generate prefix
Date:   Mon, 16 Dec 2019 19:12:32 +0800
Message-Id: <1576494752-31595-1-git-send-email-lijiazi@xiaomi.com>
...
---
changes in v2:
 - use "overlayfs: " instead of KBUILD_MODNAME
---
