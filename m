
        by smtp.gmail.com with ESMTPSA id ffacd0b85a97d-3e7cde81491sm16557991f8f.42.2025.09.16.06.59.34
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 16 Sep 2025 06:59:35 -0700 (PDT)
...
Subject: [PATCH v4 02/12] fs: use ->i_state accessors in core kernel
Date: Tue, 16 Sep 2025 15:58:50 +0200
Message-ID: <20250916135900.2170346-3-mjguzik@gmail.com>
...
index 54c480e874cb..75015a189ac8 100644
...
index ead4dc85debd..c606b99a2838 100644
--- a/fs/buffer.c
+++ b/fs/buffer.c
...
index 6088a67b2aae..edeca83a9068 100644
--- a/fs/fs-writeback.c
+++ b/fs/fs-writeback.c
...
index bf7503760206..aeb7d94f0a03 100644
--- a/fs/inode.c
+++ b/fs/inode.c
...
+	inode_state_set_raw(inode, I_FREEING | I_CLEAR);
 }
...
+	inode_state_add_raw(inode, I_CREATING);
...
@@ -2946,7 +2943,8 @@ void dump_inode(struct inode *inode, const char *reason)
 	pr_warn("%s encountered for inode %px\n"
 		"fs %s mode %ho opflags 0x%hx flags 0x%x state 0x%x count %d\n",
 		reason, inode, sb->s_type->name, inode->i_mode, inode->i_opflags,
-		inode->i_flags, inode->i_state, atomic_read(&inode->i_count));
+		inode->i_flags, inode_state_read_once(inode),
+		atomic_read(&inode->i_count));
 }
 
 EXPORT_SYMBOL(dump_inode);
diff --git a/fs/libfs.c b/fs/libfs.c
index ce8c496a6940..ecb6bc16c5a1 100644
--- a/fs/libfs.c
+++ b/fs/libfs.c
...
+	inode_state_set_raw(inode, I_DIRTY);
 	/*
 	 * Historically anonymous inodes don't have a type at all and
 	 * userspace has come to rely on this.
diff --git a/fs/namei.c b/fs/namei.c
index cd43ff89fbaa..edfacedd3b00 100644
--- a/fs/namei.c
+++ b/fs/namei.c
...
index 731622d0738d..a7e2e8907b63 100644
--- a/fs/pipe.c
+++ b/fs/pipe.c
...
index e721148c95d0..e12c39e6ffad 100644
...
index d54171f13c7a..11eef4ef5ace 100644
--- a/include/linux/fs.h
+++ b/include/linux/fs.h
@@ -2682,8 +2682,8 @@ static inline int icount_read(const struct inode *inode)
  */
...
index a2848d731a46..ab7f98e8392c 100644
...
index 1e23919c0da9..1f69499b5338 100644
...
index 783904d8c5ef..7fd826f708f1 100644
--- a/mm/backing-dev.c
+++ b/mm/backing-dev.c
