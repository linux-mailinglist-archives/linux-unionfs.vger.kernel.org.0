...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 46CBE4F7DF6
	for <lists+linux-unionfs@lfdr.de>; Thu,  7 Apr 2022 13:23:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S244769AbiDGLZK (ORCPT <rfc822;lists+linux-unionfs@lfdr.de>);
        Thu, 7 Apr 2022 07:25:10 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52590 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S244766AbiDGLZJ (ORCPT
        <rfc822;linux-unionfs@vger.kernel.org>);
        Thu, 7 Apr 2022 07:25:09 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [145.40.68.75])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F017232985
        for <linux-unionfs@vger.kernel.org>; Thu,  7 Apr 2022 04:23:08 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id 878ABB826CD
        for <linux-unionfs@vger.kernel.org>; Thu,  7 Apr 2022 11:23:07 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id C4A12C385A8;
        Thu,  7 Apr 2022 11:23:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1649330586;
        bh=3CrFkUjGWlVStvGtuNkLAHrVB237P4i0PRRB4ChVwiw=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v5 11/19] ovl: use ovl_path_getxattr() wrapper
Date:   Thu,  7 Apr 2022 13:21:48 +0200
Message-Id: <20220407112157.1775081-12-brauner@kernel.org>
X-Mailer: git-send-email 2.32.0
In-Reply-To: <20220407112157.1775081-1-brauner@kernel.org>
References: <20220407112157.1775081-1-brauner@kernel.org>
MIME-Version: 1.0
X-Developer-Signature: v=1; a=openpgp-sha256; l=16421; h=from:subject; bh=3CrFkUjGWlVStvGtuNkLAHrVB237P4i0PRRB4ChVwiw=; b=owGbwMvMwCU28Zj0gdSKO4sYT6slMST5nfSeGrHr2Y6btrH/Jl2p/Bjhuev/FcaE7BO9p1X9bV1D bEtLO0pZGMS4GGTFFFkc2k3C5ZbzVGw2ytSAmcPKBDKEgYtTACZyg5nhf530afEI1g9yK39d+3ZLhG FC+9V9cgcvuZ4omn4jcOeTo7WMDO8Wb5ltZ+O/61joUfE5cTzf+kTU9KelxW195CXbXr5zCQ8A
...
index bb05604f998c..4ab62e9b2b7a 100644
...
index 261fc08de1db..2f5d44fde887 100644
--- a/fs/overlayfs/overlayfs.h
+++ b/fs/overlayfs/overlayfs.h
@@ -218,15 +218,15 @@ static inline int ovl_do_symlink(struct ovl_fs *ofs,
 	return err;
 }
...
@@ -234,14 +234,26 @@ static inline ssize_t ovl_getxattr(struct ovl_fs *ofs, struct dentry *dentry,
...
+	int err = vfs_setxattr(ovl_upper_mnt_userns(ofs), dentry, name, value, size, flags);
 	...
 	return err;
@@ -257,7 +269,7 @@ static inline int ovl_setxattr(struct ovl_fs *ofs, struct dentry *dentry,
...
@@ -393,9 +405,27 @@ struct file *ovl_path_open(struct path *path, int flags);
...
+}
 int ovl_check_setxattr(struct ovl_fs *ofs, struct dentry *upperdentry,
 		       ...
 		       int xerr);
@@ -407,10 +437,9 @@ bool ovl_need_index(struct dentry *dentry);
...
@@ -431,7 +460,7 @@ static inline bool ovl_test_flag(unsigned long flag, struct inode *inode)
...
+	return ovl_check_dir_xattr(OVL_FS(sb), dentry, OVL_XATTR_IMPURE);
 ...
 /*
@@ -658,8 +687,7 @@ int ovl_fileattr_set(struct user_namespace *mnt_userns,
