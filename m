Return-Path: <linux-unionfs+bounces-2549-lists+linux-unionfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-unionfs@lfdr.de
Delivered-To: lists+linux-unionfs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 1661AC57977
	for <lists+linux-unionfs@lfdr.de>; Thu, 13 Nov 2025 14:15:28 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 7BAD13A54F7
	for <lists+linux-unionfs@lfdr.de>; Thu, 13 Nov 2025 13:06:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5A0F935295F;
	Thu, 13 Nov 2025 13:03:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="EkEhhpLi"
X-Original-To: linux-unionfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3387B34D91E;
	Thu, 13 Nov 2025 13:03:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1763039018; cv=none; b=mH9Jkucu/izoypEpSfcbG72XVpLYnGSLJGd2vg9pKw6y/YcJjS1WJ1AK/6W9y0KZKom+yhYOd59T+fUsObrYDTr5jMTsCV2MZbrWKBYt36PVCGjUR8TbflNKvsN0dWk5yhebiPM/lzxSA1oHIB3pzlcHkYgLQUxOnNuObflu6Tk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1763039018; c=relaxed/simple;
	bh=ovWfWNGcQcHJnNDi1bywktRTmX7U2LpwKNy70WAwv1o=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=mX9nOKvGsBvA4M6bBDjbpXFhGsEtCm78cfCOKu8PXzyfbaEAZj7t0MZe9bxpOT8zMZ2IWIxytFey/oLwQhWu9FS/lHFlUGKmYt1YQN37Qv3T3dTYWUyPHA5bsndD/tGh5WjDjgeoX2BU10Zfp4Aq4UbxrLts5lhLMQnPiXuCWsU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=EkEhhpLi; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 73F9BC4CEF5;
	Thu, 13 Nov 2025 13:03:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1763039017;
	bh=ovWfWNGcQcHJnNDi1bywktRTmX7U2LpwKNy70WAwv1o=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:From;
	b=
From: Christian Brauner <brauner@kernel.org>
Date: Thu, 13 Nov 2025 14:01:57 +0100
Subject: [PATCH RFC 37/42] ovl: refactor ovl_lookup()
Precedence: bulk
...
Message-Id: <20251113-work-ovl-cred-guard-v1-37-fa9887f17061@kernel.org>
...
X-Developer-Signature: v=1; a=openpgp-sha256; l=14693; i=brauner@kernel.org;
 h=from:subject:message-id; bh=ovWfWNGcQcHJnNDi1bywktRTmX7U2LpwKNy70WAwv1o=;
 b=owGbwMvMwCU28Zj0gdSKO4sYT6slMWSKXntyWC1RSd/P6a//quYp+y2//T9ocd5Kyb/Z/dsa1
 lmGZ+vWdZSyMIhxMciKKbI4tJuEyy3nqdhslKkBM4eVCWQIAxenAExEKIfhD8+F44bG5vbiqjem
 C1c/jr4lJjHXyY7h4a+kHh+fN5OqzRkZ9l3h3GzL9VR8+zGWdase61fYBivcY4ovURdWyF6+6et
 XXgA=
...
---
 fs/overlayfs/namei.c | 317 ++++++++++++++++++++++++++-------------------------
 1 file changed, 163 insertions(+), 154 deletions(-)

diff --git a/fs/overlayfs/namei.c b/fs/overlayfs/namei.c
index 49874525cf52..fcdc807f41c3 100644
--- a/fs/overlayfs/namei.c
+++ b/fs/overlayfs/namei.c
@@ -1070,57 +1070,45 @@ static bool ovl_check_follow_redirect(struct ovl_lookup_data *d)
 	return true;
 }
...
@@ -1131,50 +1119,50 @@ struct dentry *ovl_lookup(struct inode *dir, struct dentry *dentry,
...
+			return err;
 		...
 		if (!this)
 			continue;
@@ -1183,11 +1171,11 @@ struct dentry *ovl_lookup(struct inode *dir, struct dentry *dentry,
...
@@ -1200,23 +1188,23 @@ struct dentry *ovl_lookup(struct inode *dir, struct dentry *dentry,
...
@@ -1226,15 +1214,15 @@ struct dentry *ovl_lookup(struct inode *dir, struct dentry *dentry,
 			dput(this);
 			this = NULL;
 		} else {
...
+		if (d->redirect && d->redirect[0] == '/' && poe != roe) {
 			...
 			i = lower.layer->idx - 1;
@@ -1245,12 +1233,12 @@ struct dentry *ovl_lookup(struct inode *dir, struct dentry *dentry,
...
+		return err;
 	...
 	/*
@@ -1261,20 +1249,20 @@ struct dentry *ovl_lookup(struct inode *dir, struct dentry *dentry,
...
+		ctx->origin_path = NULL;
 	...
 	/*
@@ -1296,38 +1284,39 @@ struct dentry *ovl_lookup(struct inode *dir, struct dentry *dentry,
...
@@ -1336,77 +1325,97 @@ struct dentry *ovl_lookup(struct inode *dir, struct dentry *dentry,
...
+		if (IS_ERR(d->upperredirect))
+			return PTR_ERR(d->upperredirect);
